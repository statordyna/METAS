...
void robotino_fsm_node::getCostsGrid(const std_msgs::Float32MultiArray::ConstPtr &msg){
...
robotino_fsm_node::robotino_fsm_node(ros::NodeHandle nh, ros::NodeHandle private_nh) : nh_(nh),
    ...
    subCostsGrid = nh_.subscribe<std_msgs::Float32MultiArray>("/ipp_custom/costs_grid", 1, &robotino_fsm_node::getCostsGrid, this);
